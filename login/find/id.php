...
<div class="find_id">
  ...
  <div class="common_area">
    ...
    <!-- 인증수단 휴대폰 -->
    <form action="./find_id.php" method="post" class="find_input_area active" name="find_form" id="form_phone">
      <div id="phone_name_area">
        <div class="id_name_area">
          <label for="name" class="find_input_name">이름</label>
          <div class="name_input">
            <input id="name" name="name" placeholder="이름을 입력해 주세요" type="text" class="input-text name_input_box" value="">
            <button class="delete_content" type="button"></button>
          </div>
        </div>
        <p class="error_text">가입 시 등록한 이름을 입력해 주세요.</p>
      </div>
      ...
      <div class="auth_num">
        ...
        <button class="btn_phone_ok" type="button" disabled>
          <span class="btn_ok_text">확인</span>
        </button>
      </div>
    </form>
    <!-- 인증수단 이메일 -->
    <form action="./find_email.php" method="post" class="find_input_area" name="find_form" id="form_email">
